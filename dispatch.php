...
if (!isset($_POST["btnProcessCall"]) && !isset($_POST["btnProcessCall"]))
...
if (isset($_POST["btnDispatch"])) {
	...
	$patrolcarDispatched = $_POST["chkPatrolcar"]; //array of patrolcars being dispatched from postback
...
<body>
<!-- display the incident information passed fron logcall.php -->
	...
	<table class="ContentStyle">
		...
		<tr>
			...
			<td><textarea name="incidentDesc" cols="45" rows="5" readonly id="incidentDesc"><?php echo $_POST["incidentDesc"]; ?></textarea>
				<input type="hidden" name="incidentDesc" id="incidentDesc" value=<?php echo $_POST["incidentDesc"]; ?>">
			</td>
		</tr>
...
<?php
	...
	// retrieve from patrolcar table those patrol cas that are 2:On Patrol or 3:Free
